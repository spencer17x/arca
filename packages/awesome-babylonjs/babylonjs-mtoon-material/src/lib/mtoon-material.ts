...
export class MToonMaterial extends PushMaterial {
	...
	public constructor(name: string, scene?: Scene) {
		...
		serializeAsTexture('diffuseTexture')(this, '_diffuseTexture');
		expandToProperty('_markAllSubMeshesAsTexturesAndMiscDirty')(this, 'diffuseTexture');
		serializeAsTexture('emissiveTexture')(this, '_emissiveTexture');
		expandToProperty('_markAllSubMeshesAsTexturesDirty')(this, 'emissiveTexture');
		serializeAsTexture('bumpTexture')(this, '_bumpTexture');
		expandToProperty('_markAllSubMeshesAsTexturesDirty')(this, 'bumpTexture');
		serializeAsTexture('shadeTexture')(this, '_shadeTexture');
		expandToProperty('_markAllSubMeshesAsTexturesDirty')(this, 'shadeTexture');
		serializeAsTexture('receiveShadowTexture')(this, '_receiveShadowTexture');
		expandToProperty('_markAllSubMeshesAsTexturesDirty')(this, 'receiveShadowTexture');
		serializeAsTexture('shadingGradeTexture')(this, '_shadingGradeTexture');
		expandToProperty('_markAllSubMeshesAsTexturesDirty')(this, 'shadingGradeTexture');
		serializeAsTexture('rimTexture')(this, '_rimTexture');
		expandToProperty('_markAllSubMeshesAsTexturesDirty')(this, 'rimTexture');
		serializeAsTexture('matCapTexture')(this, '_matCapTexture');
		expandToProperty('_markAllSubMeshesAsTexturesDirty')(this, 'matCapTexture');
		serializeAsTexture('outlineWidthTexture')(this, '_outlineWidthTexture');
		expandToProperty('_markAllSubMeshesAsTexturesDirty')(this, 'outlineWidthTexture');
		serializeAsTexture('outlineWidthTexture')(this, '_uvAnimationMaskTexture');
		expandToProperty('_markAllSubMeshesAsTexturesDirty')(this, 'uvAnimationMaskTexture');

		serializeAsColor3('diffuse')(this, 'diffuseColor');
		serialize('ambient')(this, 'ambientColor');
		serialize('emissive')(this, 'emissiveColor');
		serialize('shade')(this, 'shadeColor');
		serialize('rim')(this, 'rimColor');
		serialize('outline')(this, 'outlineColor');
		expandToProperty('_markAllSubMeshesAsTexturesDirty')(this, 'useEmissiveAsIllumination');
		expandToProperty('_markAllSubMeshesAsTexturesDirty')(this, 'linkEmissiveWithDiffuse');
		expandToProperty('_markAllSubMeshesAsTexturesDirty')(this, 'useReflectionOverAlpha');
		serialize('disableLighting')(this, '_disableLighting');
		expandToProperty('_markAllSubMeshesAsLightsDirty')(this, 'disableLighting');

		serialize()(this, 'alphaCutOff');
		serialize('useAlphaFromDiffuseTexture')(this, '_useAlphaFromDiffuseTexture');
		expandToProperty('_markAllSubMeshesAsTexturesAndMiscDirty')(this, 'useAlphaFromDiffuseTexture');
		serialize('maxSimultaneousLights')(this, '_maxSimultaneousLights');
		expandToProperty('_markAllSubMeshesAsLightsDirty')(this, 'maxSimultaneousLights');
		serialize('invertNormalMapX')(this, '_invertNormalMapX');
		expandToProperty('_markAllSubMeshesAsTexturesDirty')(this, 'invertNormalMapX');
		serialize('invertNormalMapY')(this, '_invertNormalMapY');
		expandToProperty('_markAllSubMeshesAsTexturesDirty')(this, 'invertNormalMapY');
		serialize('twoSidedLighting')(this, '_twoSidedLighting');
		expandToProperty('_markAllSubMeshesAsTexturesDirty')(this, 'twoSidedLighting');

		serialize()(this, 'bumpScale');
		serialize()(this, 'receiveShadowRate');
		serialize()(this, 'shadingGradeRate');
		serialize()(this, 'shadeShift');
		serialize()(this, 'shadeToony');
		serialize()(this, 'lightColorAttenuation');
		serialize()(this, 'indirectLightIntensity');
		serialize()(this, 'rimLightingMix');
		serialize()(this, 'rimFresnelPower');
		serialize()(this, 'rimLift');
		serialize()(this, 'outlineWidth');
		serialize()(this, 'outlineScaledMaxDistance');
		serialize()(this, 'outlineLightingMix');
		serialize()(this, 'uvAnimationScrollX');
		serialize()(this, 'uvAnimationScrollY');
		serialize()(this, 'uvAnimationRotation');
		serialize('alphaTest')(this, '_alphaTest');
		serialize()(this, 'alphaTest');
		serialize()(this, 'alphaBlend');
		serialize('debugMode')(this, '_debugMode');
		expandToProperty('_markAllSubMeshesAsMiscDirty')(this, 'debugMode');
		expandToProperty('_markAllSubMeshesAsMiscDirty')(this, 'outlineWidthMode');
		serialize()(this, 'cullMode');
		serialize()(this, '_outlineCullMode');
		expandToProperty('_markAllSubMeshesAsMiscDirty')(this, 'outlineCullMode');
		serialize('flipU')(this, 'flipU');
		serialize('flipV')(this, 'flipV');
		serialize()(this, 'useLogarithmicDepth');
